...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/homegambar1.png" style="width: 100%;  height: 650px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #7b614c; border-bottom: 2px solid #7b614c;">Toko Kue Maknyuss! adalah salah satu pelopor pertama dalam bisnis roti modern di Indonesia. Didirikan pada tahun 2023,  saat ini dikelola di bawah Mahasiswa Dandi Gus S. Produk kami sehat, bergizi, dan terjangkau oleh semua orang.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #7b614c; margin-top: 80px;"><b>Produk Kami</b></h2>
