...
<html>
<head>
	<title>Toko Kue Maknyuss! - Dandi Gus Safitri</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6289670154774</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> dandydenny07@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Toko Kue Maknyuss! - Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #7b614c"><b>TOKO KUE MAKNYUSS!</b></a>
			</div>
